...
with open("Source/Ind_cmp.csv") as csvfile:
  ...
  for row in readCSV:
    ...
    scope = "Individual"
    link_mail = row[ord('I')-65]
    link_sheet = row[ord('J')-65]
    link_bpa = row[ord('K')-65]
    title = row[ord('C')-65]
    date_start = row[ord('E')-65]
    date_end = row[ord('F')-65]
    time_start = row[ord('E')-65]
    time_end = row[ord('F')-65]
    boType = row[ord('G')-65]
    station = row[ord('D')-65]
    owner_proc = row[ord('L')-65]
    owner_1stProcAud = row[ord('R')-65]
    owner_2ndProcAud = row[ord('U')-65]
    owner_ing = row[ord('O')-65]
    owner_1stIngAud = row[ord('X')-65]
    owner_2ndIngAud = row[ord('Z')-65+1]
    reason_1stProcAud = row[ord('S')-65]
    reason_2ndProcAud = row[ord('V')-65]
    reason_1stIngAud = row[ord('Y')-65]
    reason_2ndIngAud = row[ord('Z')-65+2]
...
with open("Source/Ind_run.csv") as csvfile:
  ...
  for row in readCSV:
    ...
    scope = "Individual"
    link_mail = row[ord('H')-65]
    link_sheet = row[ord('I')-65]
    link_bpa = row[ord('J')-65]
    title = row[ord('B')-65]
    date_start = row[ord('D')-65]
    date_end = row[ord('E')-65]
    time_start = row[ord('D')-65]
    time_end = row[ord('E')-65]
    boType = row[ord('F')-65]
    station = row[ord('C')-65]
    owner_proc = row[ord('K')-65]
    owner_1stProcAud = row[ord('Q')-65]
    owner_2ndProcAud = row[ord('T')-65]
    owner_ing = row[ord('O')-65]
    owner_1stIngAud = row[ord('W')-65]
    owner_2ndIngAud = row[ord('Z')-65]
    reason_1stProcAud = row[ord('R')-65]
    reason_2ndProcAud = row[ord('U')-65]
    reason_1stIngAud = row[ord('X')-65]
    reason_2ndIngAud = row[ord('Z')-65+1]
